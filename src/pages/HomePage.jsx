  ...
  return <div className="page home-page">
    <section className="hero hero-polished">
      <div className="hero-copy">
        <span className="pill-label"><Sparkles size={14}/> LỚP 8A7 · GIỜ TỰ HỌC</span>
      ...
      <div className="planner-mock">
        <div className="mock-window">
          <div className="mock-top"><div className="mock-dots"><i/><i/><i/></div><span>8A7 Self-Study</span><small>● Online</small></div>
